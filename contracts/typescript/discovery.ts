...
assert.equal(report.data.data.migration_support.from, "1.3.0");
assert.equal(report.data.data.migration_support.to, report.data.data.schema_version);
assert.equal(report.data.data.migration_support.safe, true);
assert.equal(report.data.data.migration_support.requires_pre_upgrade_backup, true);
assert.equal(report.data.data.migration_support.in_place_downgrade, false);
assert.equal(report.data.data.migration_support.recovery, "restore_pre_upgrade_backup");
